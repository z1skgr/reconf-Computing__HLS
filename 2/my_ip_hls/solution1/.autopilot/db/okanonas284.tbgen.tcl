...
set portList { 
	...
	{ rule1cnt_V_buf_dout sc_in sc_lv 32 signal 0 } 
	{ rule1cnt_V_buf_empty_n sc_in sc_logic 1 signal 0 } 
	{ rule1cnt_V_buf_read sc_out sc_logic 1 signal 0 } 
}
set NewPortList {[ 
