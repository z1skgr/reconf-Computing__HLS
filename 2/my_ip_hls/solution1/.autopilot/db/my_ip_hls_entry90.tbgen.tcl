set moduleName my_ip_hls_entry90
...
set C_modelName {my_ip_hls.entry90}
set C_modelType { void 0 }
set C_modelArgList {
	{ rule1_V int 32 regular {fifo 0}  }
	{ rule2_V int 32 regular {fifo 0}  }
	{ rule3_V int 32 regular {fifo 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "rule1_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "rule3_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ rule1_V_dout sc_in sc_lv 32 signal 0 } 
	{ rule1_V_empty_n sc_in sc_logic 1 signal 0 } 
	{ rule1_V_read sc_out sc_logic 1 signal 0 } 
	{ rule2_V_dout sc_in sc_lv 32 signal 1 } 
	{ rule2_V_empty_n sc_in sc_logic 1 signal 1 } 
	{ rule2_V_read sc_out sc_logic 1 signal 1 } 
	{ rule3_V_dout sc_in sc_lv 32 signal 2 } 
	{ rule3_V_empty_n sc_in sc_logic 1 signal 2 } 
	{ rule3_V_read sc_out sc_logic 1 signal 2 } 
	{ rule1cnt_V_dout sc_in sc_lv 32 signal 3 } 
	{ rule1cnt_V_empty_n sc_in sc_logic 1 signal 3 } 
	{ rule1cnt_V_read sc_out sc_logic 1 signal 3 } 
	{ rule2cnt_V_dout sc_in sc_lv 32 signal 4 } 
	{ rule2cnt_V_empty_n sc_in sc_logic 1 signal 4 } 
	{ rule2cnt_V_read sc_out sc_logic 1 signal 4 } 
	{ rule3cnt_V_dout sc_in sc_lv 32 signal 5 } 
	{ rule3cnt_V_empty_n sc_in sc_logic 1 signal 5 } 
	{ rule3cnt_V_read sc_out sc_logic 1 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rule3_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "rule3_V", "role": "dout" }} , 
 	{ "name": "rule3_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rule3_V", "role": "empty_n" }} , 
 	{ "name": "rule3_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rule3_V", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "rule3_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	rule3_V { ap_fifo {  { rule3_V_dout fifo_data 0 32 }  { rule3_V_empty_n fifo_status 0 1 }  { rule3_V_read fifo_update 1 1 } } }
